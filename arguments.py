...
def get_arguments():
    ...
    parser.add_argument('--lr', type=float, default=0.0001, help='Learning rate for the model. default 0.0001')
    parser.add_argument('--lr_scheduler_on', type=bool, default=True, help='Learning rate for the model. default True')
    parser.add_argument('--gamma', type=float, default=0.999, help='gamma for the learning rate scheduler. default 0.999')
    parser.add_argument('--step_size', type=int, default=1, help='step size for learning rate scheduler. default 1')
